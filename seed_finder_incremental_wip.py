...
INDEX_NAME = "card_sequences_4d"  # Elasticsearch index name
...
def search_for_partial_sequence(client, partial_sequence):
    """Search for seeds that contain the given partial card sequence."""
    ...
    try:
        ...
        if hits:
            ...
            for hit in hits:
                ...
                matching_seeds.append(seed_key)
...
def main():
    ...
    while len(matching_seeds) > 1:
        ...
        if not matching_seeds:
            ...
            print(f"\nSingle seed found: {matching_seeds[0]}")
